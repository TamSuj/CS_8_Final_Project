...
#ifndef SFML_TEMPLATE_CONSTANTS_H
#define SFML_TEMPLATE_CONSTANTS_H
...
const sf::Color TEXT_BOX_OUTLINE_COLOR = sf::Color(179, 179, 179);
const sf::Vector2f INPUT_BOX_SIZE = {300, DEFAULT_TEXT_SIZE+20};
